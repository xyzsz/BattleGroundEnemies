		...
		profile = {
			...
			Enemies = {
				...
				["15"] = {
					...
					Tank_Enabled = true,
					Tank_BasicPoint = "LEFT",
					Tank_RelativeTo = "Racial",
					Tank_RelativePoint = "RIGHT",
					Tank_OffsetX = 2,
					Tank_Width = 28,
					Tank_ShowNumbers = true,
					
					Tank_Cooldown_Fontsize = 12,
					Tank_Cooldown_Outline = "OUTLINE",
					Tank_Cooldown_EnableTextshadow = false,
					Tank_Cooldown_TextShadowcolor = {0, 0, 0, 1},

					TankFiltering_Enabled = false,
					TankFiltering_Filterlist = {}, --key = spellID, value = spellName or false
			...
			Allies = {
				...
				["15"] = {
					...
					Tank_Enabled = true,
					Tank_BasicPoint = "RIGHT",
					Tank_RelativeTo = "Racial",
					Tank_RelativePoint = "LEFT",
					Tank_OffsetX = 1,
					Tank_Width = 28,
					Tank_ShowNumbers = true,
...
function CombatLogevents.SPELL_CAST_SUCCESS(self, srcName, destName, spellID)
	...
	if playerButton then
		...
		elseif Data.TankSpellIDtoCooldown[spellID] then --Tank used, maybe?
			playerButton.Tank:TankUsed(spellID)
		else
